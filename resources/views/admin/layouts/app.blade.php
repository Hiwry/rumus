...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('admin.quotes.create') }}" class="nav-link {{ request()->routeIs('admin.quotes.*') ? 'active' : '' }}">
                    <span class="nav-icon">
    ...
    <nav class="mobile-bottom-nav">
        ...
        <a href="{{ route('admin.quotes.create') }}" class="bottom-nav-item {{ request()->routeIs('admin.quotes.*') ? 'active' : '' }}">
